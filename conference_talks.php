...
$sql_talks .= "AND track IN ('Keynotes','General','Machine Learning','Reproducible Science') ";
$sql_talks .= "ORDER BY FIELD(track,'Keynotes','General','Machine Learning','Reproducible Science'), title";
...
<p>Listed below are confirmed talks for SciPy2013.</p>
...
<a href="#Keynotes">Keynotes</a> | <a href="#General">General</a> | <a href="#Machine Learning">Machine Learning</a> | <a href="#Reproducible Science">Reproducible Science</a>
</div>
