...
<form id="formID" class="formular" method="post" action="presenters_edit_p2.php">

<div class="form_row">

<p>Edit Schedule Info:</p>
<table class="form">
  <tr>
...
<table>
  <tr>
    <td colspan="4"><label for="">Talk Title</label><br /><textarea name='title' cols="80"><?php echo $title ?></textarea></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><label for="">Video Link</label><br /><input type='text' size='80' name='video_link' value='<?php echo $video_link ?>'></td>
  </tr>
  <tr>
