...
<tr>
  ...
  if ($row['location'] == '1')
   { 
$display_block .="
<td><strong><a href=\"presenters_edit.php?id=" . $row['presenter_id'] . "\">" . $row['title'] . "</a></strong><br /> - " . $row['last_name'] . ", " . $row['first_name'] . "<br />" . $row['track'] . "<br />" . $row['start_time_f'] . "<br />presenter_id:" . $row['presenter_id'] . "<br />talk_id:" . $row['talk_id'] . "<br />schedule_id:" . $row['schedule_id'] . "</td>";
