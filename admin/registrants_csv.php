...
$result = @mysql_query($sql_registrants, $connection) or die("Error #". mysql_errno() . ": " . mysql_error());
  ...
  header( 'Content-Disposition: attachment;filename=scipy2012_registrants.csv' );
  //
